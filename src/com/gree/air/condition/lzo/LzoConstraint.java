 ...
 * @author shevek
 */
public class LzoConstraint {
	
	public static final int SPEED = 0x0a;
	public static final int MEMORY = 0x0b;
	public static final int COMPRESSION = 0x0c;
	public static final int SAFETY = 0x0d;
