...
public class FileConstant {
	...
	public static final String[] FILE_NAME_ARRAY = { FILE_NAME_SMS_PASSWORD, FILE_NAME_DATA_TRANSM,
			...
			FILE_NAME_TRANSMIT_CHANGE_END_TIME, FILE_NAME_TRANSMIT_PUSHKEY_END_TIME, FILE_NAME_TCP_SIG_PERIOD,
			FILE_NAME_TRANSMIT_CHECK_PERIOD, FILE_NAME_TRANSMIT_CHECK_END_TIME, FILE_NAME_APN_CMCC, FILE_NAME_APN_CUCC,
			FILE_NAME_SMS_USER, FILE_NAME_SMS_ADMIN, FILE_NAME_BAUD_RATE, FILE_NAME_OPEN_START_TIME,
			FILE_NAME_OPEN_END_TIME, FILE_NAME_CLOSE_START_TIME, FILE_NAME_CLOSE_END_TIME };
